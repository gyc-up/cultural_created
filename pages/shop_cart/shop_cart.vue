<template>
	<view class="car">
		...
		<view class="no_car_data" v-else @click="toBuyGoods">购物车中没有商品 <text>立即订购</text></view>

		<!-- 底部fixed Next部分 -->
		<view class="fixed_footer_next" v-if="all_num>0">
			<view class="next_box" @click="toNext">
				<view class="next_num">
					<view>{{total_number}}</view>
				</view>
				<view class="next_txt">结算</view>
